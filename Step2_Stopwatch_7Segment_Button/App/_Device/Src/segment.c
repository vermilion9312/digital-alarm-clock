...
void Segment_Update(Segment* this)
{
...
void Segment_SetRunning(Segment* this, bool running)
{
	Counter_SetRunning(this->counter, running);
}

void Segment_ResetCount(Segment* this)
{
