...
void App_Loop(void)
{
	...
	if (Input_IsFallingEdge(&button_1)) Output_Toggle(&rightRed);
	if (Input_IsFallingEdge(&button_2)) Output_Toggle(&rightGreen);
	if (Input_IsFallingEdge(&button_3)) Output_Toggle(&rightBlue);
}
